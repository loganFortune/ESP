...
autocor_mutual_info_phase_space(patient, timeinitsec=0, timeendsec=3036)
#visualization_phase_space(patient, channel, useowndelay=True, delay=delay, timeinitsec=0, timeendsec=-1)
